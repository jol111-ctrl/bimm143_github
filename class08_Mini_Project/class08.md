...
The black mass in the middle with red lines stands out to me the most.
It is very difficult to understand because everything is packed
together.
...
The plots are distinguished between the blue and reds, and it is a
organized scatter plot.
...
The component is the rowname and row. There are no features larger than
the `concave.points_mean` because according to the bar graph, it is the
largest one.
...
The results above is my favorite because, in my opinion, it looks the
most organized and easy to dinstinguish.
...
correspond the expert diagonosis
...
It seperates them out pretty well because group 1 consists of mostly “M”
and group 2 consists of mostly “B”.
...
The hierarchical clustering models also separates the diagnoses pretty
well but it also includes a 2 and 4 section, which I don’t know what it
relates to.
...
Patient 2 because they are more likely to be diagnosed as malignant than
patient 1.
